    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['jacoco:userrole:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['jacoco:userrole:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['jacoco:userrole:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['jacoco:userrole:export']"
        >导出</el-button>
      </el-col>
    </el-row>

    <el-table v-loading="loading" :data="userroleList" @selection-change="handleSelectionChange">
...
<script>
import { listUserrole, getUserrole, delUserrole, addUserrole, updateUserrole, exportUserrole } from "@/api/jacoco/userrole";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listUserrole(this.queryParams).then(response => {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有【请填写功能名称】数据项?', "警告", {
          ...
          return exportUserrole(queryParams);
        }).then(response => {
